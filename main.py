...
class HomePage(CTkFrame):
    ...
    def load_widgets(self):
        ...
        self.start_button = CTkButton(self, text="Start", font=("Times New Roman", 31),
                                 text_color = "black", fg_color = '#ba181b', hover_color = '#a4161a', height= int(self.controller.window_height / 98),
        ...
        self.LearnMore_button = CTkButton(self, text="Learn More", font=("Times New Roman", 31), height= int(self.controller.window_height / 98),
        ...
        self.exit_button = CTkButton(self, text="Exit", font=("Times New Roman", 31), height= int(self.controller.window_height / 98), 
                                 text_color = "black", fg_color = '#ba181b', hover_color = '#a4161a',
                                 border_color="#d3d3d3", corner_radius = 3, border_width= 1,
